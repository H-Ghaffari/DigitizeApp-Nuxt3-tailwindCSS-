<template>
    <nav
        class="2xl:max-w-screen-2xl mx-auto hidden md:flex bg-white md:h-20 lg:h-24 2xl:h-28 mb-5 shadow-lg sticky top-0 z-10 items-center">
        <div class="container mx-auto 2xl:max-w-screen-2xl flex items-center justify-between px-4">
            <!--menu-->
            <div class="flex items-center">
                <div> <svg xmlns="http://www.w3.org/2000/svg" width="99" height="26" fill="none" class="ml-5">
                        <path fill="#222F5D"
                ...
                <ul
                    class="class flex items-center justify-center gap-x-2 2xl:gap-x-4 text-slate-800 md:text-base lg:text-lg xl:text-xl 2xl:text-2xl">
                    <li>
                        <NuxtLink to="/"
                            class="px-2 py-4 block hover:bg-gray-100 rounded-lg transition-all duration-500 cursor-pointer font-bold">
                            خانه</NuxtLink>
                    </li>
                    <li><a class="px-2 py-4 block hover:bg-gray-100 rounded-lg transition-all duration-500 cursor-pointer ">تلفن
                            همراه</a></li>
                    <li><a class="px-2 py-4 block hover:bg-gray-100 rounded-lg transition-all duration-500 cursor-pointer ">لپ
                            تاپ</a>
                    </li>
                    <li><a class="px-2 py-4 block hover:bg-gray-100 rounded-lg transition-all duration-500 cursor-pointer ">ساعت
                            هوشمند</a></li>
                </ul>
            </div>
            <!-- search -->
            <div class="bg-stone-100 rounded flex items-center md:py-1 xl:py-1.5 2xl:py-2 px-2 md:w-1/4 lg:w-2/5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    class="md:w-6 md:h-6 xl:w-7 xl:h-7 2xl:w-9 2xl:h-9 fill-slate-800">
                    <path fill-rule="evenodd"
                        d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z"
                        clip-rule="evenodd" />
                </svg>
                <input type="text" placeholder="جستجوی نام محصول، نام برند، نام مدل و ..."
                    class="mr-1 w-full bg-transparent border-0 md:text-sm lg:text-base xl:text-lg 2xl:text-xl leading-none outline-none ring-0 focus:outline-none focus:ring-0 p-1" />
            </div>
        </div>
    </nav>
</template>